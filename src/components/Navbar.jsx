...
function Navbar({ children }) {
  ...
  return (
    <>
      <nav className="bg-white/90 backdrop-blur-md shadow-sm px-8 py-4 flex justify-between items-center sticky top-0 z-50 border-b border-gray-100">
      ...
      <main className="min-h-[calc(100vh-80px)] bg-slate-100">
        <div>
          <button
            className="ml-6 text-gray-400 border-none rounded-md px-4 py-1.5 font-bold cursor-pointer text-xs mt-2 hover:text-[#1976d2] transition-colors flex items-center gap-1"
